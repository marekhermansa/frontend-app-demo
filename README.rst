...
replace all instances of ``frontend-app-demo`` with the name of
...
This section concerns development of ``frontend-app-demo`` itself,
...
.. _Feature-based Application Organization ADR: https://github.com/openedx/frontend-app-demo/blob/master/docs/decisions/0002-feature-based-application-organization.rst
...
https://github.com/openedx/frontend-app-demo/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/frontend-app-demo
...
.. |license-badge| image:: https://img.shields.io/github/license/openedx/frontend-app-demo.svg
    :target: https://github.com/openedx/frontend-app-demo/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/openedx/frontend-app-demo/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openedx/frontend-app-demo/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openedx/frontend-app-demo/coverage.svg?branch=main
    :target: https://codecov.io/github/openedx/frontend-app-demo?branch=main
    :alt: Codecov
